...
if uploaded_file:
    ...
    st.write(f"Debug: Column names in the uploaded file: {df.columns.tolist()}")
    ...
    try:
        ...
        st.write("Debug: Successfully inserted 'CONC' and 'VLOOKUP' columns.")
    except KeyError:
        st.write("Debug: Column 'BU Name' not found in the DataFrame.")
